...
inline std::string to_string (const ClassName& rhs) 
{
	return rhs.to_string();
}

inline std::ostream& operator<< (std::ostream& os, const ClassName& rhs) 
{
	/* TODO: write object to ostream */
	return os;
}

inline std::ostream& operator<< (std::ostream& os, const ClassName::ptr rhs) 
{
	os << *rhs;
	return os;
}
...
inline std::istream& operator>> (std::istream& is, ClassName& rhs) 
{
	/* TODO: parse object from istream */
	return is;
}

inline std::istream& operator>> (std::istream& is, ClassName::ptr& rhs) 
{
